...
class LogisticRegressionClassifier(object):
    ...
    def gradient_ascent(self, dataset, labels, max_iter=10000):
        ...
        vlabels = np.matrix(labels).reshape(-1, 1)  #将数据变成一列
        m, n = dataset.shape   #dateset:(100,3)  m=100,n=3
        w = np.ones((n, 1))
        # print("w.shape",w.shape)  w.shape (3, 1)
        alpha = 0.001
        ws = []
...
if '__main__' == __name__:
    ...
    # print("dataset",dataset.shape)  (100, 3)
